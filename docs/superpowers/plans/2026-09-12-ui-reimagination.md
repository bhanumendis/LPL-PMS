...
comment on table public.notifications is 'Lyceum Placements — Placement Management System. Developed by Bhanu Mendis - Group IT. Per-recipient notifications written by database triggers.';
...
comment on table public.push_subscriptions is 'Lyceum Placements — Placement Management System. Developed by Bhanu Mendis - Group IT. Web Push subscriptions, one row per device.';
